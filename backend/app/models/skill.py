...
class Skill(Base):
    ...
    skill_root: Mapped[str] = mapped_column(Text, default="", server_default="")
    dependency_status: Mapped[str] = mapped_column(String(20), default="pending", server_default="pending")
    dependency_key: Mapped[str] = mapped_column(String(64), default="", server_default="")
    dependency_error: Mapped[str] = mapped_column(Text, default="", server_default="")
